...
public final class Msg {
    ...
    public static void info(Player to, String msg, Object... args) {
        to.sendMessage(format("&r[&3Home&r] ") + format(msg, args));
        sendActionBar(to, "&a" + msg, args);
    }

    public static void warn(Player to, String msg, Object... args) {
        to.sendMessage(format("&r[&cHome&r] &c") + format(msg, args));
        sendActionBar(to, "&c" + msg, args);
    }
